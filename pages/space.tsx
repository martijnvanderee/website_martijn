            ...
            <div className="mb-10 md:mb-0">
              <div className="md:h-96 md:overflow-auto">
                ...
                <div className="sticky md:static top-72 z-10 border-b-2 border-yellow p-3 md:mx-4 md:pt-0 bg-white">
                  <h3 className="text-center text-2xl text-black font-bold md:text-2xl ">Het laatste space nieuws!</h3>
                </div>
              ...
              <Link href={`/net-binnen/1`}>
                <div className="text-2xl md:text-2xl font-semibold leading-tight text-grey ml-4 cursor-pointer" >meer space nieuws<span className="text-2xl md:text-xl font-semibold leading-tight text-purple">{">"}</span>  </div>
              </Link>
            </div>
